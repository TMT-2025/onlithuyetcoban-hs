const base = require("./01_build_chapters_1.js");
const { Chapter, Bai, Section, Sub, P, Bullet, NoteBox, DataTable, spacer,
  Document, Packer, AlignmentType, convertInchesToTwip, numbering, Img, Example, CheckQuestions, ChapterIntro } = base;
...
Packer.toBuffer(doc).then(buf => {
  require("fs").writeFileSync("./output/Tom_tat_ly_thuyet_Hoa_10_HK1_KNTT.docx", buf);
